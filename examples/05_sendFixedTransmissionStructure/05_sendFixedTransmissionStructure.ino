 ...
 *
 * Pay attention e70 support RSSI, if you want use that functionality you must enable RSSI on configuration
...
void setup() {
  ...
  // Send message
  ResponseStatus rs = e70ttl.sendFixedMessage(0, DESTINATION_ADDL, 23, &message, sizeof(Message));
...
#ifdef ENABLE_RSSI
		ResponseStructContainer rsc = e70ttl.receiveMessageRSSI(sizeof(Message));
#else
		ResponseStructContainer rsc = e70ttl.receiveMessage(sizeof(Message));
#endif
